...
public class CarView extends JFrame {
    ...
    JButton scaniaSetBed = new JButton("Scania Set Bed");
    JButton carTransportSetBed = new JButton("CarTransport Set Bed");
    ...
    private void initComponents(String title) {
        ...
        controlPanel.add(scaniaSetBed, 4);
        controlPanel.add(carTransportSetBed, 5);
        ...
        carTransportSetBed.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                carC.setTruckBed();
            }
        ...
        scaniaSetBed.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                carC.setTruckBed(degreeAmount);
            }
        });
